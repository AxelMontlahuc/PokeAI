...
double* convertState(state s) {
    ...
    for (int i=0; i<6; i++) {
        out[4*(32*32) + i*8 + 0] = (double)s.team[i].maxHP / 300.0;
        out[4*(32*32) + i*8 + 1] = (double)s.team[i].HP / 300.0;
        out[4*(32*32) + i*8 + 2] = (double)s.team[i].level / 100.0;
        out[4*(32*32) + i*8 + 3] = (double)s.team[i].ATK / 300.0;
        out[4*(32*32) + i*8 + 4] = (double)s.team[i].DEF / 300.0;
        out[4*(32*32) + i*8 + 5] = (double)s.team[i].ATK_SPE / 300.0;
        out[4*(32*32) + i*8 + 6] = (double)s.team[i].DEF_SPE / 300.0;
        out[4*(32*32) + i*8 + 7] = (double)s.team[i].SPEED / 300.0;
    }
    out[4*(32*32) + 6*8 + 0] = (double)s.PP[0] / 64.0;
    out[4*(32*32) + 6*8 + 1] = (double)s.PP[1] / 64.0;
    out[4*(32*32) + 6*8 + 2] = (double)s.PP[2] / 64.0;
    out[4*(32*32) + 6*8 + 3] = (double)s.PP[3] / 64.0;
    out[4*(32*32) + 6*8 + 4] = (double)s.enemy[0] / 300.0;
    out[4*(32*32) + 6*8 + 5] = (double)s.enemy[1] / 300.0;
    out[4*(32*32) + 6*8 + 6] = (double)s.enemy[2] / 100.0;
    out[4*(32*32) + 6*8 + 7] = (double)s.zone / 255.0;
    out[4*(32*32) + 6*8 + 8] = (double)s.clock / 255.0;
